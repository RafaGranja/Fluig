...
function verificaOS(numOS){
	...
	console.log("vou verificar se existe uma lista de materiais para a OS "+numOS)
	...
	var dataset = DatasetFactory.getDataset("dsBuscaListaOS",null,constraints,null);
