// CARREGA O CONTEÚDO DO FORMULÁRIO
$(document).ready(function(){

	// VARIÁVEL PARA GUARDAR ATIVIDADE ATUAL
	var atv = $("#ATIVIDADE").val();
	var mySimpleCalendar = FLUIGC.calendar('#DATA_PROGRAMADA');
	var mySimpleCalendar2 = FLUIGC.calendar('#NOVA_DATA');
	var mySimpleCalendar3 = FLUIGC.calendar('#NOVA_DATA2');

	var data = new Date()

	$("#dataDia").val(formataDataDate(data))
