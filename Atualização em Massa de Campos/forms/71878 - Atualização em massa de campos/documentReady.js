...
const editor = FLUIGC.codeeditor("SQLTEXT",settings);
...
$(document).ready(function(){
	...
	setTimeout(function(){
		...
		$("#ESTRUTURAPRINCIPALREV").on('click',function(event){event.preventDefault()})
		$("#ALERTAFILTROS").toggle("slow")
		$("#ALERTAALVOS").toggle("slow")

		$("[data-send]",window.parent.document).next().prop("disabled",true)
		$("[data-send]",window.parent.document).prop("disabled",true)
...
$(".escondeaviso").on("click",function(){

	$("#ALERTAFILTROS").toggle("slow")
	$("#BOTAOVIEWFILTRO").toggle("slow")

})

$(".escondeaviso2").on("click",function(){

	$("#ALERTAALVOS").toggle("slow")
	$("#BOTAOVIEWALVO").toggle("slow")

})


$(".preenchefiltros").on("click",function(){
