...
function trocaIndice(indice,idCriacao){
	...
	if(nivel=="" || nivel==undefined || nivel==null){
		...
		reloadZoomFilterValues("F_INDICE_REF","OS,"+numOS+"NIVEL,"+nivel+",IDCRIACAO,"+idCriacaoPai+",NOTINDICE,"+indice)
		
	} else{
		
		// FAZ O RELOAD ZOOM NA CONSULTA DOS INDICES
		reloadZoomFilterValues("F_INDICE_REF","OS,"+numOS+",IDCRIACAO,"+idCriacaoPai+",NOTINDICE,"+indice)
