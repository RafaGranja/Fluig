...
var idprd = hAPI.getCardValue("IDPRDREQ")
var codigoPrd = hAPI.getCardValue("COMPONENTEREQ")
var qtde = hAPI.getCardValue("QTDEREQ")
var precoUnit = hAPI.getCardValue("CUSTOMEDIOREQ")
var codloc = hAPI.getCardValue("CODLOCREQ")
var codColigada = hAPI.getCardValue("CODCOLIGADAREQ")
var codFilial = hAPI.getCardValue("CODFILIALREQ")
var codlocDestino = "23" 
var numPlanoCorte = hAPI.getCardValue("NUMPLANO")
var numOS = hAPI.getCardValue("OSREQ")
var codOrdem = hAPI.getCardValue("OPREQ")
var idAtvOrdem = hAPI.getCardValue("IDATVREQ")
...
log.info("idprd: "+idprd+", codigoPrd: "+codigoPrd+", qtde: "+qtde+", precoUnit: "+precoUnit+", " +
		"codloc: "+codloc+", codColigada: "+codColigada+", " +
...
//if( !(temMovTransferencia(codColigada,codFilial,codOrdem,idAtvOrdem,idprd) ) ){
	...
	if( !( (qtde=="" || qtde==null || qtde==undefined || qtde=="null") && (precoUnit=="" || precoUnit==null || precoUnit==undefined || precoUnit=="null") ) ){
		...
		var XML = "<MovMovimento >" +   
			...
			"	 <CAMPOLIVRE3>" + numPlanoCorte + "</CAMPOLIVRE3>" +
			"  </TMOV>" +
			"  <TNFE>" +   
			"    <CODCOLIGADA>" + codColigada + "</CODCOLIGADA>" +   
			"    <IDMOV>-1</IDMOV>" +   
	    ...
	    try{
    	 	  ...
    	 	  if ((result != null) && (result.indexOf("===") != -1)){
    			  ...
    			  var idmov = result.substring(result.search(";") + 1, result.length);
        	 	  ...
        	 	  log.info("idmov gerado: "+idmov)
        	 	  
        	 	  hAPI.setCardValue("IDMOVREQ",idmov)
