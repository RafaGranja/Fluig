...
function createDataset(fields, constraints, sortFields) {
	...
	log.info("ENTREI NO DATASET dsUpdateDadosItemOS")
	
	var dsUpdateDadosItemOS = DatasetBuilder.newDataset();
    ...
    var myQuery = "UPDATE Z_CRM_ML001005 " +
    			  ...
    			  produtoRM+" "+idprd+" "+codigoPrd+" "+
    			  dataRevisao+" "+obsDesenho+" "+pesoBruto+" "+pesoLiquido+" "+perimetroCorte+" "+areaPintura+" "+obsProcesso+" "+obsGeral+" "+qtdeUnComp+" "+
    			  " "+tipoDesenho+" "+areaSecao+" "+altura+" "+larguraAba+" "+espAlma+" "+espAba+" "+material+" "+indice+" "+comporLista+" "+codigoTarefa+" "+codTrfItem+" "+
    			  idTrfItem+" "+nomeTrfItem+" "+numDocDelp+" "+revisaoDocDelp+" "+diametroExtDisco+" "+diametroIntDisco+" "+pesoUnit+" "+pesoUnitLiq+" "+opsUnitarias+" "+
    			  " "+recmodifiedon+" "+recmodifiedby+" "+itemderetorno+" "+
    			  //codTrfPai+" "+idTrfPai+" "+nomeTrfPai+" "+
    			  numOS+" "+idCriacao
    
    			  
    log.info("QUERY dsUpdateDadosItemOS: " + myQuery);
