...
function createDataset(fields, constraints, sortFields) {
    ...
    var myQuery = "SELECT ID ,companyid ,cardid ,documentid ,version ,tableid ,TITULOITEM ,NIVEL ,POSICAO ,DESCRICAO ,NUMDESENHO ,REVISAODESENHO ," +
    		...
    		"QTDEUNCOMP ,IDCRIACAOPAI ,RECCREATEDBY ,RECCREATEDON ,RECMODIFIEDBY ,RECMODIFIEDON ,PESOUNLIQUIDO, ITEMDERETORNO FROM Z_CRM_ML001005 WHERE OS='"+numOS+"' "+idCriacao+" "+nivel
