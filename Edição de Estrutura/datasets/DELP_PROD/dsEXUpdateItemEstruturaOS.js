...
function createDataset(fields, constraints, sortFields) {
	...
	log.info("ENTREI NO DATASET dsEXUpdateItemEstruturaOS")
	
	var dsEXUpdateItemEstruturaOS = DatasetBuilder.newDataset();
    ...
    var myQuery = "UPDATE Z_CRM_EX001005 " +
    			  ...
    			  idTrfItem+" "+nomeTrfItem+" "+numDocDelp+" "+revisaoDocDelp+" "+diametroExtDisco+" "+diametroIntDisco+" "+opsUnitarias+" "+pesoUn+" "+pesoBruto+" "+pesoLiquido+" "+pesoUnLiq+" "+
    			  //" "+codTrfPai+" "+idtrfPai+" "+nomeTrfPai+" "
	  			  " "+recmodifiedby+" "+recmodifiedon+" "+itemderetorno+" "+
    			  numOS+" "+idCriacao+" "+execucao
   
    			  
    log.info("QUERY dsEXUpdateItemEstruturaOS: " + myQuery);
    ...
    return dsEXUpdateItemEstruturaOS;
