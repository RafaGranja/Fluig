function beforeTaskSave(colleagueId,nextSequenceId,userList){
    ...
    log.info("Entrei no beforeTaskSave Processo de Edição de Estrutura (v2)");
	...
	if(activity==28){
		...
		log.info("entrei na atividade 11")
    ...
    log.info("finalizei o beforeTaskSave do Processo de Edição")
}
...
function CadastraProduto (codcoligada, codfilial, numProcess){
    ...
    log.info("beforeTaskSave - CadastraProduto -  Inclusão de novo produto - Edição de Estrutura")
    ...
    for (var i=0; i < dataset.rowsCount; i++){
    	...
    	if((idprd=="" || idprd==null || idprd==undefined || idprd=="null") && !(tipo=="NAOMANUFATURADO" || tipo=="INDUSTRIALIZACAO")){
