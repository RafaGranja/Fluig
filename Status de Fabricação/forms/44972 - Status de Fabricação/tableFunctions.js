...
// INCLUI UM NOVO ITEM NA TABELA DA LISTA DE OPS
function addListaOPS(){
	
	console.log("Entrei para adicionar um item na tabela de lista de OPS")
	
	var row = wdkAddChild('LISTAOPS')
