...
$(document).ready(function(){
	...
	setTimeout(function(){
		...
		$("#textActivity",window.parent.document).remove()
		$("#workflowview-header>#collapse-tabs",window.parent.document).remove()
		
		$("#wcm_footer",window.parent.document).hide()

		//$("#workflowView-cardViewer",window.parent.document).eq(0).css("height","100%")

		//$(".fixedTopBar",window.parent.document).show()
		$("#workflowActions",window.parent.document).show()
		$("body").css("padding-top","0%")

		$(".modal").find("select:not([id*='FILIAL'])").prop("disabled",true)
