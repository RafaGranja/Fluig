...
if (constraints != null) {
    ...
    var myQuery = "SELECT DISTINCT CONCAT(OS,' - ',DESCOS) DESCRICAOOS ,OS, DESCOS, CODCOLIGADA, CODFILIAL FROM Z_CRM_ML001005 WHERE NIVEL='' AND CODCOLIGADA LIKE '%"+codcoligada+"' AND CODFILIAL LIKE '%"+codfilial+"'"
