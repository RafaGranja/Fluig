...
function createDataset(fields, constraints, sortFields) {
	...
	var mprj = " INNER JOIN MPRJ PJ ON PJ.CODCOLIGADA = I.CODCOLIGADA AND PJ.CODPRJ = I.CODCCUSTO AND PJ.POSICAO IN (1,4) "+ 		
					"	INNER JOIN MTRF T ON PJ.CODCOLIGADA = T.CODCOLIGADA AND PJ.IDPRJ = T.IDPRJ AND I.CODORDEM = T.CODTRFAUX  	"+	
					"	INNER JOIN MTRFCOMPL TR ON I.CODCOLIGADA = TR.CODCOLIGADA AND TR.IDPRJ = PJ.IDPRJ AND TR.IDTRF = T.IDTRF "
	var mprj2 = " ,T.CODTRF,T.IDTRF "
    ...
    var myQuery = 	"SELECT TOP 100 "+
					...
					"	INNER JOIN FLUIG.DBO.Z_CRM_EX001005 Z ON Z.CODCOLIGADA=I.CODCOLIGADA AND Z.CODFILIAL=I.CODFILIAL AND I.CODCCUSTO=Z.OS COLLATE SQL_Latin1_General_CP1_CI_AI "+
