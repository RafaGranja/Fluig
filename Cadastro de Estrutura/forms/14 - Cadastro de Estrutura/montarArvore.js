...
function confirmaIncluirFilho(){
	...
	setTimeout(function(){
		...
		// SE NUM DESENHO OU DESCRIÇÃO NÃO FOI PREENCHIDO
		if(numDesenho=="" || descricao=="" || posicao=="" || quantidade==""){
...
function trocaIndice(indice,idCriacao){
	...
	if(nivel=="" || nivel==undefined || nivel==null){
		...
		console.log("fazer o reload pelo nivel")
		
		// FAZ O RELOAD ZOOM NA CONSULTA DOS INDICES
		reloadZoomFilterValues("F_INDICE_REF","OS,"+numOS+",NIVEL,"+nivel+",NOTINDICE,"+indice)
		
	} else{
		
		// FAZ O RELOAD ZOOM NA CONSULTA DOS INDICES
		reloadZoomFilterValues("F_INDICE_REF","OS,"+numOS+",NOTINDICE,"+indice)
